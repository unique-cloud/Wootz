    ...
    with slim.arg_scope(default_arg_scope(is_training)):
      ...
      with tf.variable_scope(end_point):
        ...
        with tf.variable_scope('branch_1'):
            branch_1 = slim.conv2d(net, 64, [1, 1], scope='inception_a1_3x3_a_reduce')
            branch_1 = slim.conv2d(branch_1, 64, [3, 3], scope='inception_a1_3x3_a')
        with tf.variable_scope('branch_2'):
            branch_2 = slim.conv2d(net, 64, [1, 1], scope='inception_a1_3x3_b_reduce')
            branch_2 = slim.conv2d(branch_2, 96, [3, 3], scope='inception_a1_3x3_b1')
      ...
      with tf.variable_scope(end_point):
        ...
        with tf.variable_scope('branch_1'):
            branch_1 = slim.conv2d(net, 64, [1, 1], scope='inception_a2_3x3_a_reduce')
            branch_1 = slim.conv2d(branch_1, 96, [3, 3], scope='inception_a2_3x3_a')
        with tf.variable_scope('branch_2'):
            branch_2 = slim.conv2d(net, 64, [1, 1], scope='inception_a2_3x3_b_reduce')
            branch_2 = slim.conv2d(branch_2, 96, [3, 3], scope='inception_a2_3x3_b1')
      ...
      with tf.variable_scope(end_point):
        with tf.variable_scope('branch_0'):
            branch_0 = slim.conv2d(net, 128, [1, 1], scope='reduction_a_3x3_a_reduce')
            branch_0 = slim.conv2d(branch_0, 160, [3, 3], stride=2, scope='reduction_a_3x3_a')
        with tf.variable_scope('branch_1'):
            branch_1 = slim.conv2d(net, 64, [1, 1], scope='reduction_a_3x3_b_reduce')
            branch_1 = slim.conv2d(branch_1, 96, [3, 3], scope='reduction_a_3x3_b1')
      ...
      with tf.variable_scope(end_point):
        ...
        with tf.variable_scope('branch_1'):
            branch_1 = slim.conv2d(net, 64, [1, 1], scope='inception_b1_3x3_a_reduce')
            branch_1 = slim.conv2d(branch_1, 96, [3, 3], scope='inception_b1_3x3_a')
        with tf.variable_scope('branch_2'):
            branch_2 = slim.conv2d(net, 96, [1, 1], scope='inception_b1_3x3_b_reduce')
            branch_2 = slim.conv2d(branch_2, 128, [3, 3], scope='inception_b1_3x3_b1')
      ...
      with tf.variable_scope(end_point):
        ...
        with tf.variable_scope('branch_1'):
            branch_1 = slim.conv2d(net, 96, [1, 1], scope='inception_b2_3x3_a_reduce')
            branch_1 = slim.conv2d(branch_1, 128, [3, 3], scope='inception_b2_3x3_a')
        with tf.variable_scope('branch_2'):
            branch_2 = slim.conv2d(net, 96, [1, 1], scope='inception_b2_3x3_b_reduce')
            branch_2 = slim.conv2d(branch_2, 128, [3, 3], scope='inception_b2_3x3_b1')
      ...
      with tf.variable_scope(end_point):
        ...
        with tf.variable_scope('branch_1'):
            branch_1 = slim.conv2d(net, 128, [1, 1], scope='inception_b3_3x3_a_reduce')
            branch_1 = slim.conv2d(branch_1, 160, [3, 3], scope='inception_b3_3x3_a')
        with tf.variable_scope('branch_2'):
            branch_2 = slim.conv2d(net, 128, [1, 1], scope='inception_b3_3x3_b_reduce')
            branch_2 = slim.conv2d(branch_2, 160, [3, 3], scope='inception_b3_3x3_b1')
      ...
      with tf.variable_scope(end_point):
        ...
        with tf.variable_scope('branch_1'):
            branch_1 = slim.conv2d(net, 128, [1, 1], scope='inception_b4_3x3_a_reduce')
            branch_1 = slim.conv2d(branch_1, 192, [3, 3], scope='inception_b4_3x3_a')
        with tf.variable_scope('branch_2'):
            branch_2 = slim.conv2d(net, 160, [1, 1], scope='inception_b4_3x3_b_reduce')
            branch_2 = slim.conv2d(branch_2, 192, [3, 3], scope='inception_b4_3x3_b1')
      ...
      with tf.variable_scope(end_point):
        with tf.variable_scope('branch_0'):
            branch_0 = slim.conv2d(net, 128, [1, 1], scope='reduction_b_3x3_a_reduce')
            branch_0 = slim.conv2d(branch_0, 192, [3, 3], stride=2, scope='reduction_b_3x3_a')
        with tf.variable_scope('branch_1'):
            branch_1 = slim.conv2d(net, 192, [1, 1], scope='reduction_b_3x3_b_reduce')
            branch_1 = slim.conv2d(branch_1, 256, [3, 3], scope='reduction_b_3x3_b1')
      ...
      with tf.variable_scope(end_point):
        ...
        with tf.variable_scope('branch_1'):
            branch_1 = slim.conv2d(net, 192, [1, 1], scope='inception_c1_3x3_a_reduce')
            branch_1 = slim.conv2d(branch_1, 320, [3, 3], scope='inception_c1_3x3_a')
        with tf.variable_scope('branch_2'):
            branch_2 = slim.conv2d(net, 160, [1, 1], scope='inception_c1_3x3_b_reduce')
            branch_2 = slim.conv2d(branch_2, 224, [3, 3], scope='inception_c1_3x3_b1')
      ...
      with tf.variable_scope(end_point):
        ...
        with tf.variable_scope('branch_1'):
            branch_1 = slim.conv2d(net, 192, [1, 1], scope='inception_c2_3x3_a_reduce')
            branch_1 = slim.conv2d(branch_1, 320, [3, 3], scope='inception_c2_3x3_a')
        with tf.variable_scope('branch_2'):
            branch_2 = slim.conv2d(net, 192, [1, 1], scope='inception_c2_3x3_b_reduce')
            branch_2 = slim.conv2d(branch_2, 224, [3, 3], scope='inception_c2_3x3_b1')
